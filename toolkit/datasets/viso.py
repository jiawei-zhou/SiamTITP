...
class VISOVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(VISOVideo, self).__init__(name, root, video_dir,
...
class VISODataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(VISODataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = VISOVideo(video,
                                          dataset_root,
