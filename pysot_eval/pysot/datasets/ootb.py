...
class OOTBVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(OOTBVideo, self).__init__(name, root, video_dir,
...
class OOTBDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(OOTBDataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = OOTBVideo(video,
                                          dataset_root,
