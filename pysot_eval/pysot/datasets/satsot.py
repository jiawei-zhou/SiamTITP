...
class SatSotVideo(Video):
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names,
        ...
        super(SatSotVideo, self).__init__(name, root, video_dir,
    ...
    def load_tracker(self, path, tracker_names=None, store=True):
        ...
        for name in tracker_names:
            ...
            if os.path.exists(traj_file):
                try:
                    delimiter = ','
                    pred_traj = np.loadtxt(traj_file,delimiter=delimiter)
                except:
                    delimiter = '\t'
                    pred_traj = np.loadtxt(traj_file,delimiter=delimiter)
...
class SatSOTDataset(Dataset):
    ...
    def __init__(self, name, dataset_root, load_img=False):
        super(SatSOTDataset, self).__init__(name, dataset_root)
        ...
        for video in pbar:
            ...
            self.videos[video] = SatSotVideo(video,
                                          dataset_root,
...
if __name__ == '__main__':
    name = 'SatSOT'
    root = '/home/zhoujiawei/satellite video datasets/SatSOT'
    da = SatSOTDataset(name,root)